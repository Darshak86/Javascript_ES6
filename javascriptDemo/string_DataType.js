...
// codePointAt(position) : returns the Unicode value at an index (position) in a string.
...
// constructor : returns the function that created the String prototype.
console.log(text.constructor); // ƒ String() { [native code] }

// endsWith() : returns true if a string ends with a specified string. method is case sensitive.
